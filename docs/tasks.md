...
## Estado general
En progreso: v0.6.0 exportación HTML inicial del Markdown renderizado.
...
## Completadas
- [x] v0.6.0: exportación HTML inicial implementada (acción en menú Medo, helper dedicado, tests unitarios y validación de build/lint/test).
